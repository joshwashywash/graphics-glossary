...
Surfaces have more [specular reflection](https://en.wikipedia.org/wiki/Specular_reflection) when viewed at near-grazing angles. This phenomenon is often called the fresnel factor. It is typically one of the contributing terms in physically-based rendering. The fresnel factor is often approximated using [Schlick's approximation](https://en.wikipedia.org/wiki/Schlick%27s_approximation).
