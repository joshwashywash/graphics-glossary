...
import Shadow from "@components/examples/shadows/simple-shadow/shadow/app.svelte";
import SimpleShadow from "@components/examples/shadows/simple-shadow/simple-shadow/app.svelte";

export const shadowColor = "orangered";
...
<SimpleShadow client:only />
<Tabs directory="shadows/simple-shadow" />
