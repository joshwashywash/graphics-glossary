...
A sprite is a 2D flat plane that always faces the camera. By swapping out the texture, the illusion of a 3D model can be achieved all while keeping the geometry extremely simple. This strategy was extremely common in the early days of 3D video game development in order to work within the limitations of the hardware developers would
