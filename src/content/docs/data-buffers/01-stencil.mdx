...
The stencil buffer is an opt-in feature because it requires extra space which may go unused if the application don't need to utilize the stencil buffer.
